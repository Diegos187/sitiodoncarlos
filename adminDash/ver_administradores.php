...
$adminActualId = $_SESSION['user_id'];
?>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($row['id'] == $adminActualId) { ?>
                            <!-- Botón desactivado para el administrador actual -->
                            <button class="btn-bajar-cargo" style="background-color: grey; color: white;" disabled>Actual</button>
                        <?php } else { ?>
                            <!-- Botón activo para otros administradores -->
...
<div id="modalBajarCargo" class="modal">
    <div class="modal-content">
        ...
        <form id="formBajarCargo">
            <input type="hidden" id="adminId" name="userId"> 
